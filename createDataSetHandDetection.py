...
# ติดตั้งไลบรารีที่จำเป็น: ติดตั้ง Mediapipe และ OpenCV สำหรับการประมวลผลวิดีโอและการตรวจจับมือ
# เก็บข้อมูลจาก Mediapipe: ใช้ Mediapipe ในการตรวจจับมือจากวิดีโอหรือภาพ
# สร้าง Data Set: บันทึกตำแหน่งของจุดต่าง ๆ บนมือที่ Mediapipe ตรวจจับได้ในแต่ละเฟรมของวิดีโอ
# บันทึกลงในไฟล์ CSV: แปลงข้อมูลให้อยู่ในรูปแบบที่สามารถใช้กับโมเดล CNN + LSTM และบันทึกเป็นไฟล์ CSV
import cv2
